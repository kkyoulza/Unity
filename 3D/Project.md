...
<nav>
  <ul>
    <li><a href="#first">캐릭터 움직임(대쉬, 구르기 등), 공격</a></li>
    <li><a href="#second">몬스터, 보스(추적, 근거리, 원거리 공격)</a></li>
    <li><a href="#third">무기 강화, 스텟 강화, 상점</a></li>
    <li><a href="#fourth">미니게임(점프 맵), 던전 스테이지, 재화 파밍용 돌</a></li>
    <li><a href="#fifth">UI(아이템 창, 스텟 창 등)</a></li>
  </ul>
</nav>
